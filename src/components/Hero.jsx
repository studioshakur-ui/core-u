  ...
  return (
    <section className="relative overflow-hidden bg-[url('/images/hero-blur.png')] bg-cover bg-center">
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">CORE v10 — <span className="text-core-violet">Ops</span> navali intelligenti</h1>
          <p className="mt-4 text-white/70">Accedi, assegna squadre, compila rapportini, e monitora KPI settimanali.</p>
