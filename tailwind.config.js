...
export default {
  ...
  theme: {
    extend: {
      colors: {
        neutral: { 10:'#FFFFFF', 25:'#F5F5F5', 100:'#1A1A1A' },
        capo: { DEFAULT:'#1DB954',600:'#18a64b',700:'#148b3f' },
        petrol:'#005F73',
        orangeSoft:'#FF7849',
        success:'#22C55E',
        danger:'#DC2626',
      ...
      borderRadius:{xl:'1rem','2xl':'1.25rem',premium:'1.5rem'},
      boxShadow:{
      ...
      fontSize:{
        xs:['12px','18px'],sm:['14px','20px'],base:['16px','24px'],lg:['20px','28px'],
        xl:['24px','32px'],'2xl':['32px','40px'],'3xl':['40px','48px'],
      }
    },
  },
